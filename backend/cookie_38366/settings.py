"""
Django settings for cookie_38366 project.
...
ROOT_URLCONF = 'cookie_38366.urls'
...
WSGI_APPLICATION = 'cookie_38366.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cookie_38366 API",
    "DESCRIPTION": "API documentation for cookie_38366 App",
    "VERSION": "v1",
}
